...
describe('<ResetPasswordForm /> styled components', () => {
  it('should match the stored <StyledForm /> snapshot', () =>
    expectToMatchSnapshot(<StyledForm />));

  it('should match the stored <Title /> snapshot', () =>
    expectToMatchSnapshot(<Title />));

  it('should match the stored <FormLabel /> snapshot', () =>
    expectToMatchSnapshot(<FormLabel />));

  it('should match the stored <InputError /> snapshot', () =>
    expectToMatchSnapshot(<InputError />));

  it('should match the stored <ButtonWrapper /> snapshot', () =>
    expectToMatchSnapshot(<ButtonWrapper />));
