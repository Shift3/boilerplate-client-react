...
describe('with generated profile picture', () => {
    ...
    const testUser: User = UserFactory.build({ firstName: "Test", lastName: "User" }, { transient: { hasProfilePicture: true } });
...
describe('with provided profile picture', () => {
    ...
    const testUser = UserFactory.build({}, { transient: { hasProfilePicture: false }, associations: { profilePicture: testProfilePicture }});
